...
export async function getStaticProps(context) {
    ...
    const response = await fetch(process.env.NEXT_PUBLIC_API_URL +"api/getHomePageStaticData?pageName=contact_us");
    ...
    return {
        props: {
            ...
            openGraphData: [
                {
                    property: "og:image",
                    content: process.env.NEXT_PUBLIC_NEXT_PUBLIC_SITE_URL + data?.image,
                    key: "ogimage",
                },
                {
        ...
        <>
            <Layout>              
                ...
                <Head>
                    ...
                    <meta property="og:title" content={data?.header_text} key="og-title" />
                    <meta property="og:description" content={data?.page_text} key="og-desc" />
                    <meta property="og:image" content={process.env.NEXT_PUBLIC_SITE_URL + data?.image} key="og-image" />
                    ...
                    <meta property="twitter:image" content={process.env.NEXT_PUBLIC_SITE_URL + data?.image} />
